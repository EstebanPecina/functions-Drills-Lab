...
function helloWorld() { // function set up
  console.log('Hello, World!'); //what the console will log
}
helloWorld();  //printing out the function in console.
...
function printName (name) {
  console.log(name) //console logs the name
}
printName('Cameron') //setting the printName value to ('Cameron') or whatever name to change terminal print.
